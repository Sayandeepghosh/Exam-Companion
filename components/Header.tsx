...
const Header: React.FC<HeaderProps> = ({ activePage, onMenuClick }) => {
  return (
    <header className="fixed top-0 left-0 right-0 z-20 flex items-center justify-start gap-4 p-4 h-16 bg-surface/80 dark:bg-dark-surface/80 backdrop-blur-lg border-b border-outline/20 dark:border-dark-outline/20">
      <button
        onClick={onMenuClick}
